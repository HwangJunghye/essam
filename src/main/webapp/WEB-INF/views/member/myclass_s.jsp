	...
	<div id="contents_area">
		...
		<c:if test="${!empty clsInfo}">
			<c:forEach var="cInfo" items="${clsInfo}">
				<div class="clsList" onclick="location.href='${ctxPath}/class/curriculum?clsNo=${sInfo.clsNo}'">
					<p class="clsCate">${cInfo.cate1Name}>${cInfo.cate2Name}</p>
					<span class="clsTitle">${cInfo.clsName}</span> <span
						class="clsLimit">(${cInfo.clsRegiCnt}/${cInfo.clsLimit})</span>
